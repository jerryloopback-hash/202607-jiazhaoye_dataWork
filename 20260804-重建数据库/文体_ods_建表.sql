...
CREATE TABLE `ods_wenti_jianengliang_coupon_combination`  (
  ...
  `update_user` varchar(255) NULL DEFAULT NULL COMMENT 'SCENETYPE',
  ...
  `path` varchar(255) NULL DEFAULT NULL COMMENT '类型描述',
  `remark` varchar(255) NULL DEFAULT NULL COMMENT '范围描述',
  `bgName` varchar(255) NULL DEFAULT NULL COMMENT '类型',
...
CREATE TABLE `ods_wenti_jianengliang_coupon_combination_ref`  (
  ...
  `typeDes` varchar(255) NULL DEFAULT NULL COMMENT '商城TICKETTYPE',
  `rangeDes` varchar(255) NULL DEFAULT NULL COMMENT '商城票',
  `type` int(2) NULL DEFAULT NULL COMMENT '商城TICKETGRANULARITY',
  `name` varchar(255) NULL DEFAULT NULL COMMENT '大麦颗粒度',
...
CREATE TABLE `ods_wenti_jianengliang_coupon_range`  (
  ...
  `damai_type` varchar(255) NULL DEFAULT NULL COMMENT 'ID',
  `damai_project_id` varchar(255) NULL DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 281
  DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE `ods_wenti_jianengliang_j_activity_statistics`  (
  ...
  `tag1` varchar(255) NULL DEFAULT NULL COMMENT '更新时间',
  `tag2` varchar(255) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `ods_wenti_jianengliang_j_coupon`  (
  ...
  `name` varchar(128) NOT NULL COMMENT '是否删除D',
...
CREATE TABLE `ods_wenti_jianengliang_j_coupon_code`  (
  ...
  `name` varchar(128) NOT NULL COMMENT '创建时间',
...
CREATE TABLE `ods_wenti_jianengliang_j_member`  (
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `phone` varchar(12) NULL DEFAULT NULL COMMENT '注册手机',
  ...
  `province` varchar(16) NULL DEFAULT NULL COMMENT '省',
  `city` varchar(16) NULL DEFAULT NULL COMMENT '市',
  `area` varchar(16) NULL DEFAULT NULL COMMENT '区',
  `sex` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '性别 0不明 1男 2女',
  `avatar` varchar(512) NULL DEFAULT NULL COMMENT '用户头像',
  ...
  `register_source` varchar(50) NULL DEFAULT NULL COMMENT '注册来源(子场馆id)',
  ...
  `venue_id` varchar(50) NULL DEFAULT NULL COMMENT '场馆id',
  ...
  `mini_qrcode` varchar(255) NULL DEFAULT NULL COMMENT '小程序分享二维码',
  ...
  `id_card` varchar(255) NOT NULL DEFAULT '0' COMMENT 'id_card',
  `user_name` varchar(255) NULL DEFAULT '' COMMENT '姓名',
  ...
  `child_id_card` varchar(255) NULL DEFAULT '0' COMMENT '儿童id_card',
  `child_birthday` varchar(20) NULL DEFAULT NULL COMMENT '儿童生日',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `ik_venue_id`(`venue_id`) USING BTREE,
  INDEX `phone`(`phone`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 1379211
  DEFAULT CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci
  COMMENT = '用户'
  ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- ods_wenti_jianengliang_j_order_coupon   订单优惠券表（是否是馆佳单独的优惠券）
-- ----------------------------
...
CREATE TABLE `ods_wenti_jianengliang_j_platform_activity`  (
  ...
  `venue_name` varchar(200) NULL DEFAULT NULL,
  ...
  `update_name` varchar(200) NULL DEFAULT NULL,

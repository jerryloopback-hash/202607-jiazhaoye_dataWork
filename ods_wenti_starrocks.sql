...
CREATE TABLE `ods_wenti_jianengliang_j_member` (
    id INT NOT NULL COMMENT 'id（业务主键）',
    extract_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
    phone VARCHAR(36) NULL COMMENT '注册手机',
    password VARCHAR(192) NULL COMMENT '密码',
    nick_name VARCHAR(192) NULL COMMENT '昵称',
    birthday VARCHAR(60) NULL COMMENT '生日',
    age INT NULL COMMENT '年龄',
    province VARCHAR(48) NULL COMMENT '省',
    city VARCHAR(48) NULL COMMENT '市',
    area VARCHAR(48) NULL COMMENT '区',
    sex INT NULL COMMENT '性别 0不明 1男 2女',
    avatar VARCHAR(1536) NULL COMMENT '用户头像',
    ...
    this_login_time DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '本次登录时间',
    ...
    remark VARCHAR(768) NULL COMMENT '备注',
    ...
    register_source VARCHAR(150) NULL COMMENT '注册来源(子场馆id)',
    ...
    venue_id VARCHAR(150) NULL COMMENT '场馆id',
    ...
    mini_qrcode VARCHAR(765) NULL COMMENT '小程序分享二维码',
    ...
    id_card VARCHAR(765) NOT NULL COMMENT 'id_card',
    user_name VARCHAR(765) NULL COMMENT '姓名',
    ...
    child_id_card VARCHAR(765) NULL COMMENT '儿童id_card',
    child_birthday VARCHAR(60) NULL COMMENT '儿童生日',
...
CREATE TABLE `ods_wenti_jianengliang_buy_ticket_people` (
    ...
    type INT NOT NULL COMMENT '证件类型 1：身份证，2：驾驶证',
    name VARCHAR(120) NULL COMMENT '姓名',
    phone VARCHAR(12) NULL COMMENT '手机号',
    sex VARCHAR(4) NULL COMMENT '性别',
    id_card_status INT NULL COMMENT '身份证验证状态 0-未验证 1-验证成功 2-姓名不匹配 3-失败',
    create_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `ods_wenti_jianengliang_coupon_combination` (
  ...
  `reType` int NULL DEFAULT NULL COMMENT '',
  `reSource` int NULL DEFAULT NULL COMMENT '',
  ...
  `scenetype` int NULL DEFAULT NULL COMMENT '',
  `merchant_id` int NULL COMMENT '商户ID'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '优惠券组合表'
...
CREATE TABLE `ods_wenti_jianengliang_coupon_combination_ref` (
  ...
  `codeId` int NULL DEFAULT NULL COMMENT ''
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '优惠券组合关联表'
...
CREATE TABLE `ods_wenti_jianengliang_coupon_grant` (
  `id` int NOT NULL COMMENT '大麦PROJECTID',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `couponId` int NOT NULL COMMENT '优惠券id',
  `sceneType` int NOT NULL COMMENT '发放场景',
  `status` int NOT NULL COMMENT '0_禁用，1_启用',
  ...
  `transaction_type` int NULL DEFAULT NULL COMMENT '交易类型,1_全部交易，2_场馆交易,3_商城交易，4_票务交易，5_活动交易,6_培训交易',
  `share_num` int NULL DEFAULT NULL COMMENT '每次交易分享个数',
  `user_startTime` datetime NULL DEFAULT NULL COMMENT '用户注册开始时间',
  `user_endTime` datetime NULL DEFAULT NULL COMMENT '用户注册结束时间',
  `user_range` int NULL DEFAULT NULL COMMENT '用户注册渠道1_全部，2_小程序，3_IOS,4_Android,5_其它',
  `remarks` varchar(255) NULL DEFAULT "" COMMENT '备注',
  `user_type` int NULL COMMENT '用户范围 1.全部 2.按注册时间和注册渠道 3.按导入名单',
  `bgId` int NULL DEFAULT NULL COMMENT '礼包id',
  `merchant_id` int NULL DEFAULT NULL COMMENT '商户id'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '优惠券发放表'
...
CREATE TABLE `ods_wenti_jianengliang_coupon_grant_ref` (
  `id` int NOT NULL COMMENT '创建人姓名',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `grantId` varchar(255) NOT NULL COMMENT '优惠券发放id',
  `userid` int NOT NULL COMMENT '用户id',
  `shareNum` int NOT NULL COMMENT '已分享数量'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '优惠券发放关联表'
...
CREATE TABLE `ods_wenti_jianengliang_coupon_range` (
  `id` int NOT NULL COMMENT 'ID',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `traningVenueId` int NULL DEFAULT NULL COMMENT '培训基地id',
  `traningTypeId` int NULL DEFAULT NULL COMMENT '培训类型id',
  `traningCourseId` int NULL DEFAULT NULL COMMENT '培训课程id',
  `traningGranularity` int NULL DEFAULT NULL COMMENT '培训颗粒度，1_所有培训，2_培训基地,3_培训类型，4_培训课程',
  `goodsTypeId` int NULL DEFAULT NULL COMMENT '商品类型id',
  `goodsId` int NULL DEFAULT NULL COMMENT '商品id',
  `goodsGranularity` int NULL DEFAULT NULL COMMENT '商品颗粒度，1_所有商品，2_类型，3_商品',
  `venueId` int NULL DEFAULT NULL COMMENT '场馆id',
  `venuType` int NULL DEFAULT NULL COMMENT '场馆类型1_全部，2_订场，3_购票',
  `sportId` varchar(255) NULL DEFAULT NULL COMMENT '运动类型id',
  `ticketId` int NULL DEFAULT NULL COMMENT '票id',
  `venueGranularity` int NULL DEFAULT NULL COMMENT '场馆颗粒度,1_所有场馆，2_运动类型，2_单张票',
  `activityTypeId` int NULL DEFAULT NULL COMMENT '活动类型id',
  `activityId` int NULL DEFAULT NULL COMMENT '活动id',
  `activityGranularity` int NULL DEFAULT NULL COMMENT '活动颗粒度1_所有活动，2_活动类型，3_单个活动',
  `couponId` int NOT NULL COMMENT '优惠券码id',
  `mallTickettype` int NULL DEFAULT NULL COMMENT '',
  `mallTicket` int NULL DEFAULT NULL COMMENT '',
  `mallTicketgranularity` int NULL DEFAULT NULL COMMENT '',
  `card_id` int NULL DEFAULT NULL COMMENT '线上办卡id',
  `damai_granularity` int NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE `ods_wenti_jianengliang_coupon_receive` (
  `id` int NOT NULL COMMENT 'id',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `ref_id` int NOT NULL COMMENT '优惠券id',
  `userid` int NOT NULL COMMENT '用户id'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_jianengliang_j_activity_statistics` (
  ...
  `traffic_num` bigint NOT NULL DEFAULT "0" COMMENT '访问量',
  `share_num` bigint NOT NULL DEFAULT "0" COMMENT '分享量',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `tag1` varchar(255) NULL DEFAULT NULL COMMENT '',
  `tag2` varchar(255) NULL DEFAULT NULL COMMENT '',
  `merchant_id` int NULL DEFAULT NULL COMMENT '站点id'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '活动统计表'
...
CREATE TABLE `ods_wenti_jianengliang_j_address` (
  ...
  `city_id` int NULL DEFAULT NULL COMMENT '市',
  `area_id` int NULL DEFAULT NULL COMMENT '地区',
  `street_id` int NULL DEFAULT NULL COMMENT '街道',
  `pca_name` varchar(300) NULL DEFAULT NULL COMMENT '商户ID',
  `detailed_address` varchar(500) NULL DEFAULT NULL COMMENT '详细地址',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `is_default` int NULL DEFAULT "0" COMMENT '是否为默认地址（0：不是，1：是）'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '收货地址'
...
CREATE TABLE `ods_wenti_jianengliang_j_coupon` (
  ...
  `code_id` int NOT NULL COMMENT '优惠码id',
  `rec_type` tinyint NULL DEFAULT "0" COMMENT '领取方式1.注册 2.积分兑换 3.发老用户 4.金服注册赠送 5.自定义发放',
  `scene_type` tinyint NULL DEFAULT NULL COMMENT '适用范围 0.全场通用 1.订场售票',
  `use_type` tinyint NULL DEFAULT "0" COMMENT '使用场景 未使用_0,订场_2,游泳票_3,渠道商品订单_4,演艺票订单_5,赛事票订单_6',
  ...
  `status` tinyint NOT NULL DEFAULT "0" COMMENT '状态 1：未使用 2：已使用',
  `user_id` int NOT NULL COMMENT '会员id',
  `is_pop` tinyint NOT NULL DEFAULT "0" COMMENT '是否需要弹窗提示 1:需要',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `use_time` datetime NULL DEFAULT NULL COMMENT '使用时间',
  `description` varchar(512) NULL DEFAULT NULL COMMENT '描述',
  `update_time` datetime NULL DEFAULT NULL COMMENT 'ID',
  `viewd` tinyint NULL DEFAULT "0" COMMENT '已读状态1为已读',
  `prize_record_id` int NULL DEFAULT NULL COMMENT '奖品发放记录id',
  `discount` decimal(7, 2) NULL DEFAULT NULL COMMENT '折扣',
  `couponCodeType` int NULL DEFAULT "1" COMMENT '优惠券类型',
  `userange` int NULL DEFAULT "0" COMMENT '使用范围',
  `grantId` int NOT NULL DEFAULT "1" COMMENT '优惠券发放id',
  `combinationId` int NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE `ods_wenti_jianengliang_j_coupon_code` (
  ...
  `req_points` int NULL DEFAULT NULL COMMENT '所需积分',
  `rec_type` tinyint NOT NULL DEFAULT "0" COMMENT '领取方式 1.注册 2.积分兑换 3.发老用户 4.自定义发放',
  `scene_type` tinyint NOT NULL COMMENT '适用场景 0.全场通用 1.订场售票',
  `days` int NULL DEFAULT "0" COMMENT '有效天数 ，0表示不限制天数',
  `amount` int NULL DEFAULT "0" COMMENT '总数量 0表示不限制数量',
  `ex_amount` int NULL DEFAULT "0" COMMENT '已兑换数量',
  `use_amount` int NULL DEFAULT "0" COMMENT '已使用数量',
  `user_type` int NULL DEFAULT NULL COMMENT '用户类型 1：所有 2：根据注册时间段',
  `reg_start_time` datetime NULL DEFAULT NULL COMMENT '注册开始时间',
  `reg_end_time` datetime NULL DEFAULT NULL COMMENT '注册结束时间',
  `expire_amount` int NULL DEFAULT "0" COMMENT '过期数量',
  `send_start_time` datetime NULL DEFAULT NULL COMMENT '发放开始时间',
  `send_end_time` datetime NULL DEFAULT NULL COMMENT '发放结束时间',
  `start_time` datetime NULL DEFAULT NULL COMMENT '优惠码的有效开始时间（在此时间之后才可领取）',
  `expire_time` datetime NULL DEFAULT NULL COMMENT '优惠码的有效时间',
  `status` tinyint NOT NULL DEFAULT "0" COMMENT '状态 0.禁用 1.启用 2.假删除',
  `update_user` varchar(32) NULL DEFAULT NULL COMMENT '最后更新用户',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '最后更新时间',
  `description` varchar(512) NULL DEFAULT NULL COMMENT '描述',
  `discount` decimal(7, 2) NULL DEFAULT NULL COMMENT '折扣',
  `couponCodeType` int NULL DEFAULT "1" COMMENT '',
  `userange` int NULL DEFAULT "0" COMMENT '',
...
CREATE TABLE `ods_wenti_jianengliang_j_coupon_recive` (
  ...
  `status` int NOT NULL DEFAULT "0" COMMENT '状态0.上架 1.下架',
  `coupon_range` int NOT NULL DEFAULT "0" COMMENT '优惠券使用范围',
  ...
  `coupon_num` int NOT NULL COMMENT '优惠券发放数量',
  `recive_num` int NOT NULL DEFAULT "0" COMMENT '领取数量',
  `grant_id` int NOT NULL COMMENT '',
  `merchant_id` int NULL DEFAULT NULL COMMENT '商家ID'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_jianengliang_j_coupon_recive_city_ref` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `recive_id` int NOT NULL COMMENT '领券中心id',
...
CREATE TABLE `ods_wenti_jianengliang_j_coupon_recive_ref` (
  ...
  `recive_id` int NOT NULL COMMENT '领券id',
  `create_time` datetime NOT NULL COMMENT '创建时间'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_jianengliang_j_id_card_check_record` (
  ...
  `reason_type` int NULL DEFAULT "1" COMMENT '原因详情，1：认证通过 2：输入姓名和身份证号不一致 3：查无此身份证 7：结果获取失败，请重试',
  `status` int NOT NULL DEFAULT "0" COMMENT '认证结果，1：认证通过，2：认证不通过， 0：待定(原因参考下方reasonType字段)',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间'
)
ENGINE = OLAP
...
CREATE TABLE `ods_wenti_jianengliang_j_intelligent_info` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `business_type` int NULL DEFAULT "1" COMMENT '1 :个人中心身份认证页面, 2:游泳馆购票页面, 3:游泳馆办卡页面, 4:免费票领取页, 5:体检报告上传页，6：个人中心身份认证页面',
  `detail_type` int NULL DEFAULT "1" COMMENT '1.储值卡 2.次卡 3.时段卡, 4:散票，5：团体票，6：免费票，7：',
  `member_id` int NOT NULL COMMENT 'h_member id',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_jianengliang_j_member_free_ticket` (
  ...
  `name` varchar(20) NULL COMMENT '报名人名字',
  `venue_activity_goods_id` int NULL COMMENT '场馆活动商品id',
  `id_card` varchar(20) NULL COMMENT '身份证号',
  `id_type` int NULL COMMENT '1.中国居民身份证 2.港澳居民身份证 3.台湾居民身份证',
  `phone` varchar(20) NULL COMMENT '手机号',
  `code` varchar(20) NULL COMMENT '领取码',
  `receive_time` datetime NULL COMMENT '领取时间',
  `status` int NULL COMMENT '状态 1：待使用，2：已使用，3：用户取消 4:过期',
  `status_time` datetime NULL COMMENT '状态时间',
  `expire_time` datetime NULL COMMENT '到期时间',
  `use_time` datetime NULL COMMENT '核销时间',
  `operator_id` varchar(50) NULL COMMENT '核销人id',
  `use_begin_time` datetime NULL COMMENT '使用开始时间',
  `use_end_time` datetime NULL COMMENT '使用结束时间',
  `use_cond` int NULL COMMENT '卡限制类型,与B端UseCond保持一致',
  `ticket_type` varchar(50) NULL COMMENT '免费票类型',
  `batch_code` varchar(255) NULL COMMENT '套票批次码，用于标识套票',
  `viewd` tinyint NULL COMMENT '已读状态1为已读',
  `update_user` varchar(255) NULL COMMENT '核销人',
  `admin_check` int NULL COMMENT '后台核销',

  INDEX `ik_code` (`code`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '用户免费票记录表'
...
CREATE TABLE `ods_wenti_jianengliang_j_member_order` (
  ...
  `sport_id` varchar(255) NULL COMMENT '运动项目id',
  `cost` decimal(20, 2) NOT NULL COMMENT '应付费用,包括调价和服务费',
  `discount_amount` decimal(20, 2) NOT NULL COMMENT '优惠费用',
  `deducted_card_type` varchar(100) NULL COMMENT '专项卡抵扣类型(2011储值卡,2012储值专项,202次卡)',
  `deducted_amount` decimal(20, 2) NOT NULL COMMENT '专项卡已抵扣金额',
  `share_deducted_amount` decimal(20, 2) NOT NULL COMMENT '分摊剩余抵扣金额',
  `pay_amount` decimal(20, 2) NOT NULL COMMENT '实付费用=应付费用-优惠',
  `service_charge` decimal(10, 2) NOT NULL COMMENT '服务费',
  `order_num` varchar(64) NOT NULL COMMENT '订单号',
  `trade_no` varchar(64) NULL COMMENT '第三方支付订单号',
  `phone` varchar(11) NULL COMMENT '手机号',
  `status` varchar(50) NOT NULL COMMENT '状态：订场/游泳票订单状态取值:0:待支付 2:已支付,待使用 3:未支付,支付超时 4:已支付已使用待评价 5.已支付未使用已过期 6:已退款 7:已评价 8:用户取消订单；商品/演艺票/赛事票订单状态取值:30：已下单待支付，31：已取消，32：支付超时，33：已支付待发货，34：已支付待自取，35：已发货待收货，36：已收货待评价，37：已取票待评价，38：退款中，39：退款成功，40：退款失败，41：已完成，42：关闭订单',
  `type` varchar(50) NOT NULL COMMENT '类型 1_套餐2_订场 3 游泳票 4商品 5演艺 6赛事 7（自营）演艺周边 8（自营）赛事周边 9（自营）其他商品 10找课程',
  `pay_way` varchar(12) NULL COMMENT '支付方式 1、支付宝 2、微信 3、小程序',
  `pay_time` DATETIME NULL COMMENT '支付时间',
  `create_time` DATETIME NOT NULL COMMENT '创建时间',
  `order_time` DATETIME NULL COMMENT '订场时间, 向后台发起请求并且订场成功',
  `pay_param` varchar(4000) NULL COMMENT '阿里支付参数',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `used_points` int NULL COMMENT '使用积分',
  ...
  `pca_name` varchar(300) NULL COMMENT '省市区名称',
  `address` varchar(500) NULL COMMENT '收货人地址',
  `id_card` varchar(30) NULL COMMENT '身份證',
  `is_pay` tinyint NOT NULL COMMENT '是否已支付',
  `is_refund` tinyint NOT NULL COMMENT '是否已退款',
  `is_send` tinyint NOT NULL COMMENT '是否已发货',
  `take_way` int NULL COMMENT '获取方式（0：快递，1：自取，2：电子票）',
  `take_address` varchar(255) NULL COMMENT '自取地址',
  `status_time` DATETIME NULL COMMENT '状态时间',
  `sys_remark` varchar(3000) NULL COMMENT '（后台）订单备注',
  `handle` tinyint NOT NULL COMMENT '是否已经统计过报表',
  `merchant_id` int NULL COMMENT '站点id(当为全国时为0)',
  `commission` decimal(10, 2) NULL COMMENT '手续费',
  `channel_discount` decimal(10, 2) NULL COMMENT '渠道优惠',
  `j_merchant_id` int NULL COMMENT '商户id',
  `j_merchant_no` varchar(255) NULL COMMENT '商户号',
  `asyn_division_flag` tinyint NULL COMMENT '0.无需异步分账 1.需要异步分账',
  `asyn_sure` tinyint NULL COMMENT '0.未确认异步分账 1.已确认异步分账',
  `is_new` tinyint NOT NULL COMMENT '0.旧订单 1.新订单',

  INDEX `ik_order_num` (`order_num`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '我的套餐'
...
CREATE TABLE `ods_wenti_jianengliang_j_member_order_detail` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `order_num` varchar(255) NULL COMMENT '订单号',
  `swim_ticket_desc` varchar(255) NULL COMMENT '游泳票描述',
  `swim_ticket_expire_date` varchar(50) NULL COMMENT '游泳票有效期',
  `field_time_desc` varchar(255) NULL COMMENT '订场时间描述',
  `field_num_desc` varchar(255) NULL COMMENT '订场数量描述',
  `packages_amount` decimal(20, 2) NOT NULL COMMENT '套餐价格',
  `field_amount` decimal(20, 2) NOT NULL COMMENT '场地价格',
  `swim_ticket_amount` decimal(20, 2) NOT NULL COMMENT '游泳票价格',
  `user_remark` varchar(255) NULL COMMENT '用户购买备注',
  `take_remark` varchar(255) NULL COMMENT '用户取票备注',
  `close_remark` varchar(255) NULL COMMENT '订单关闭备注',
  `goods_take_code` varchar(20) NULL COMMENT '搭配商品领取码',
...
CREATE TABLE `ods_wenti_jianengliang_j_member_order_refund` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `order_num` varchar(255) NULL COMMENT '订单号',
  `pay_way` varchar(20) NULL COMMENT '支付方式',
  `refund_order_num` varchar(255) NULL COMMENT '退款单号',
  `refund_user` varchar(64) NULL COMMENT '退款人',
  `refund_time` datetime NULL COMMENT '退款时间',
  `refund_trade_no` varchar(255) NULL COMMENT '第三方退款流水号',
  `refund_amount` decimal(20, 2) NULL COMMENT '退款金额',
  `refund_type` int NULL COMMENT '退款方式 1原渠道退回',
  `refund_response` varchar(4000) NULL COMMENT '第三方返回响应',
  `refund_param` varchar(4000) NULL COMMENT '退款参数',
  `is_success` tinyint NULL COMMENT '是否成功',
  `fail_reason` varchar(4000) NULL COMMENT '失败原因',
  `refund_remark` varchar(255) NULL COMMENT '退款备注',
  `status` int NULL COMMENT '0：待审核，1：同意，2，拒绝',
  `check_user` varchar(64) NULL COMMENT '审核人员',
  `check_time` datetime NULL COMMENT '审核时间',
  `refuse_reason` varchar(255) NULL COMMENT '拒绝原因',
  `sup_is_refund` int NULL COMMENT '是否收到商户退款 0：否，1：是',
  `sup_refund_amount` decimal(10, 2) NULL COMMENT '商户退款金额',
  `is_only_goods` tinyint NULL COMMENT '是否只退搭配',
...
CREATE TABLE `ods_wenti_jianengliang_j_member_third` (
  ...
  `third_type` int NOT NULL COMMENT '第三方类型(1-微信,2-支付宝)',
  `third_source` int NOT NULL COMMENT '第三方注册来源(1-小程序,2-微信公众号)',
  `third_id` varchar(64) NOT NULL COMMENT '第三方id(微信为openid)',
  `union_id` varchar(64) NULL COMMENT '第三方唯一id(微信为unionid)',
  `create_time` datetime NOT NULL COMMENT '创建时间'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_jianengliang_j_member_time_card` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `card_id` int NOT NULL COMMENT '闲时卡售卖id',
  `status` int NOT NULL COMMENT '卡状态 0_待激活 1_已激活 2_已过期',
  `expire_time` datetime NOT NULL COMMENT '卡过期时间',
  `stime` varchar(255) NOT NULL COMMENT '可用时段开始时间',
  `etime` varchar(255) NOT NULL COMMENT '可用时段结束时间',
  `type` int NOT NULL COMMENT '卡类型',
  `limit_num` int NOT NULL COMMENT '单日使用限制次数',
  `user_id` int NOT NULL COMMENT '用户id',
...
CREATE TABLE `ods_wenti_jianengliang_j_order_btp` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `order_num` varchar(64) NULL COMMENT '订单号',
  `btp_id` int NULL COMMENT '购票人id',
...
CREATE TABLE `ods_wenti_jianengliang_j_order_card_expense` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `order_num` varchar(255) NULL COMMENT '订单号',
  `vip_card_id` varchar(255) NOT NULL COMMENT '专项卡id(与B端一致)',
  `vip_card_no` varchar(255) NULL COMMENT '专项卡号(与B端一致)',
  `card_no` varchar(255) NULL COMMENT '虚拟卡号(与B端一致)',
  `vip_card_type` varchar(255) NOT NULL COMMENT '专项卡类型(201-储值卡,202-次卡)',
  `deducted_amount` decimal(20, 2) NULL COMMENT '已抵扣金额',
  `spend_amount` decimal(20, 2) NULL COMMENT '卡已使用额度',
  `create_time` datetime NULL COMMENT '创建时间',
  `is_cancel` varchar(1) NOT NULL COMMENT '是否取消(0-正常,1-已取消)',
  `cancel_time` datetime NULL COMMENT '取消时间',

  INDEX `idx_order_num` (`order_num`) USING BITMAP,
  INDEX `idx_is_cancel` (`is_cancel`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '卡消费表'
...
CREATE TABLE `ods_wenti_jianengliang_j_order_field` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `order_num` varchar(255) NULL COMMENT '订单号',
  `buss_date` varchar(255) NULL COMMENT '开场日期',
  `start_time` varchar(255) NULL COMMENT '开场时间',
  `end_time` varchar(255) NULL COMMENT '结束时间',
  `item_name` varchar(255) NULL COMMENT '场地名称',
  `price` decimal(10, 2) NULL COMMENT '销售单价(不包含服务费)',
  `ori_price` decimal(10, 2) NULL COMMENT '原单价(不包含服务费)',
  `service_charge` decimal(10, 2) NOT NULL COMMENT '服务费',
  `cut_ratio` decimal(10, 2) NULL COMMENT '平台抽成比例',
  `field_id` varchar(255) NULL COMMENT '场地id',
  `price_id` varchar(255) NULL COMMENT '价格id',
  `push` int NULL COMMENT '是否已推送提示开场',
...
CREATE TABLE `ods_wenti_jianengliang_j_order_guanjia` (
  ...
  `is_give_points` tinyint NOT NULL DEFAULT "0" COMMENT '是否已送过积分',
  `user_id` int NOT NULL COMMENT '下单用户id',
  `coupon_id` bigint NULL DEFAULT NULL COMMENT '优惠券id',
  `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `gmt_updated` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `ods_wenti_jianengliang_j_order_ticket` (
  ...
  `type` int NULL DEFAULT NULL COMMENT '票类型,与B端use_condition保持一致',
  `ticket_type` int NULL DEFAULT NULL COMMENT '1：成人单次 2:一大一小 3:两大一小',
  `venue_id` int NULL DEFAULT NULL COMMENT '场馆id',
  `status` int NULL DEFAULT NULL COMMENT '使用状态 0 未使用 1已使用 2已过期',
  `description` varchar(255) NULL DEFAULT NULL COMMENT '使用说明',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `expire_time` datetime NULL DEFAULT NULL COMMENT '截止有效时间',
  `remain_num` int NOT NULL DEFAULT "0" COMMENT '剩余核销次数',
  ...
  INDEX `ik_order_num` (`order_num`) USING BITMAP,
  INDEX `ik_ticket_num` (`ticket_num`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '游泳票生成表'
...
CREATE TABLE `ods_wenti_jianengliang_j_order_ticket_valid` (
  ...
  `type` int NULL DEFAULT NULL COMMENT '票类型,与B端use_condition保持一致',
  `ticket_type` int NULL DEFAULT NULL COMMENT '1：成人单次 2:一大一小 3:两大一小',
  `is_valid` tinyint NOT NULL DEFAULT "0" COMMENT '是否已核销',
...
CREATE TABLE `ods_wenti_jianengliang_j_platform_activity` (
  ...
  `category_id` int NULL DEFAULT "0" COMMENT '活动分类id',
  `category_name` varchar(50) NULL DEFAULT "" COMMENT '活动分类名称',
  `venue_id` int NULL DEFAULT NULL COMMENT '场馆id',
  `venue_name` varchar(200) NULL DEFAULT NULL COMMENT '场馆名称',
  `introduction` VARCHAR(65533) NULL COMMENT '介绍',
  `pay_amount` decimal(12, 2) NULL DEFAULT "0.00" COMMENT '需支付金额',
  `free_sign` tinyint NULL DEFAULT "0" COMMENT '是否免费',
  `least_nums` int NULL DEFAULT "0" COMMENT '至少报名人数',
  `sign_up_nums` int NULL DEFAULT "0" COMMENT '报名人数',
  ...
  `province_id` int NULL DEFAULT NULL COMMENT '省',
  `city_id` int NULL DEFAULT NULL COMMENT '市',
  `district_id` int NULL DEFAULT NULL COMMENT '区',
  ...
  `j_merchant_id` int NULL DEFAULT NULL COMMENT '银联商户id',
  `show_list` int NULL DEFAULT "1" COMMENT '是否小程序列表展示 1-是 2-否',
  `sign_up_num_show` tinyint NOT NULL DEFAULT "1" COMMENT '是否展示报名人数 1-是 0-否',
...
CREATE TABLE `ods_wenti_jianengliang_j_platform_activity_category` (
  ...
  `sorted_num` int NOT NULL DEFAULT "0" COMMENT '排序值',
...
CREATE TABLE `ods_wenti_jianengliang_j_platform_activity_extra_attr` (
  ...
  `sorted_num` int NULL DEFAULT "0" COMMENT '排序值'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '活动报名信息项'
...
CREATE TABLE `ods_wenti_jianengliang_j_platform_activity_goods` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `activity_id` int NULL DEFAULT "0" COMMENT '活动id',
  `mall_goods_id` int NULL DEFAULT "0" COMMENT '商超商品id',
...
CREATE TABLE `ods_wenti_jianengliang_j_platform_activity_person` (
  ...
  `sign_gift_bag_id` int NULL DEFAULT "0" COMMENT '礼包id',
  ...
  `mid` int NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE `ods_wenti_jianengliang_j_points_records` (
  ...
  `points` bigint NULL DEFAULT NULL COMMENT '积分值',
  `record_time` datetime NULL DEFAULT NULL COMMENT '记录时间',
  `remark` varchar(255) NULL DEFAULT NULL COMMENT '备注',
  `platform` int NULL DEFAULT NULL COMMENT '0-一起吗 1-馆佳 2-乐火',
  `merchant_id` int NULL DEFAULT NULL COMMENT '商户id',
  ...
  `send_success` tinyint NOT NULL DEFAULT "0" COMMENT '是否推送成功',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `ods_wenti_jianengliang_j_prize_detail` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `send_prize_id` int NULL DEFAULT NULL COMMENT 'j_send_prize id',
  ...
  INDEX `ik_prize_id` (`send_prize_id`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_jianengliang_j_report_check_record` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `member_id` int NOT NULL COMMENT 'h_member 用户id（可能是馆佳）',
  `venue_id` int NOT NULL COMMENT 'venue_id 场馆id',
  ...
  `phone` varchar(255) NULL DEFAULT NULL COMMENT 'phone',
  `user_name` varchar(255) NULL DEFAULT NULL COMMENT '姓名',
  `status` int NULL DEFAULT "2" COMMENT '体检校验 2：审核中、3：审核通过、4：审核未通过、5：已过期、6：已禁用',
  ...
  `source` int NOT NULL DEFAULT "0" COMMENT '用户来源 1app2后台录入'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '体检报告表'
...
CREATE TABLE `ods_wenti_jianengliang_j_send_prize` (
  ...
  `should_num` int NULL DEFAULT NULL COMMENT '应发数量',
  `real_num` int NULL DEFAULT NULL COMMENT '实发数量',
  `prize_type` int NULL DEFAULT NULL COMMENT '奖品类型 1：线下礼品 2：邮寄礼品 3：线下优惠券 4：线上优惠券 5：积分',
  `send_status` int NULL DEFAULT NULL COMMENT '发送状态 0：发送中 1：已发送',
  `failure_num` int NULL DEFAULT NULL COMMENT '失败数量',
  `opt_user` varchar(20) NULL DEFAULT NULL COMMENT '操作人',
  `use_num` int NULL DEFAULT NULL COMMENT '使用数量',
  `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  `target_user` int NULL DEFAULT NULL COMMENT '目标用户 1.excel 2.手动输入 3。新注册用户',
  `enable` tinyint NOT NULL DEFAULT "1" COMMENT '启用，禁用'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '发放奖品记录表'
...
CREATE TABLE `ods_wenti_jianengliang_j_send_prize_record` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `send_prize_id` int NULL DEFAULT NULL COMMENT 'j_send_prize id',
  `user_id` int NULL DEFAULT NULL COMMENT '目标用户',
  ...
  `is_use` tinyint NOT NULL DEFAULT "0" COMMENT '是否核销',
  `is_pop` tinyint NOT NULL DEFAULT "0" COMMENT '是否弹窗',
  `is_view` tinyint NOT NULL DEFAULT "0" COMMENT '是否已读'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_jianengliang_j_time_card_use` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `card_id` int NOT NULL COMMENT '用户卡id',
  ...
  `user_id` int NOT NULL COMMENT '用户id',
  `status` int NOT NULL COMMENT '0.未抵扣 1.已抵扣',
  `create_time` datetime NOT NULL COMMENT '创建时间'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_jianengliang_j_venue_reserve` (
  ...
  `status` int NOT NULL DEFAULT "0" COMMENT '0 待处理 1已处理'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '用户电话预定场馆表'
...
CREATE TABLE `ods_wenti_jianengliang_p_park_customer` (
  ...
  `is_yellow_car` tinyint NULL DEFAULT NULL COMMENT '是否黄牌车',
  `is_new_enegry` tinyint NULL DEFAULT NULL COMMENT '是否新能源车',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_virtual` tinyint NOT NULL DEFAULT "0" COMMENT '是否无牌车生成的虚拟车牌',
  `certificate_no` varchar(255) NULL DEFAULT NULL COMMENT '无牌车生成的凭证号',

  INDEX `idx_phone` (`user_phone`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_training_h_card` (
  ...
  `card_status` int NOT NULL COMMENT ' 卡状态（0.未使用，1.已使用）',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '修改时间',
  `create_user_id` int NULL DEFAULT NULL COMMENT '创建人id',
  `up_user_id` int NULL DEFAULT NULL COMMENT '修改人id',
  `is_deleted` tinyint NOT NULL DEFAULT "0" COMMENT '是否删除',
  `venue_id` int NOT NULL COMMENT '场馆id',
  `merchant_id` int NOT NULL COMMENT '商户id',

  INDEX `idx_venue_id` (`venue_id`) USING BITMAP,
  INDEX `idx_card_code` (`card_code`) USING BITMAP,
  INDEX `idx_card_track` (`card_track`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '实体卡表'
...
CREATE TABLE `ods_wenti_training_h_member_course_refund` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `status` int NULL DEFAULT NULL COMMENT '状态 0-审核中 1-审核通过 2-审核拒绝 3-已退款 4-已同意',
  ...
  `update_material` tinyint NOT NULL DEFAULT "0" COMMENT '是否更新材料',
  `is_deleted` tinyint NOT NULL DEFAULT "0" COMMENT '是否删除'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
-- ----------------------------
-- ods_wenti_training_m_trade_order   订单
-- ----------------------------
...
CREATE TABLE `ods_wenti_training_m_trade_order` (
  ...
  `is_account_business` tinyint NULL DEFAULT "0" COMMENT '是否记账订单',
  ...
  `is_mini_app_pay` tinyint NULL DEFAULT "0" COMMENT '是否为小程序支付(兼容微信)',
  `pay_remark` varchar(300) NULL DEFAULT "" COMMENT '付款备注',
  `pay_time` datetime NULL DEFAULT NULL COMMENT '付款时间',
  `pay_no` varchar(100) NULL DEFAULT "" COMMENT '支付流水号',
  `pay_params` VARCHAR(65533) NULL COMMENT '第三方支付参数',
  `create_order_param` VARCHAR(65533) NULL COMMENT '下单参数',
  `origin_type` tinyint NULL DEFAULT "0" COMMENT '来源类型(是否C端订单)',
  `fail_pay_remark` varchar(300) NULL DEFAULT "" COMMENT '付款失败备注',
  `cancel_remark` varchar(300) NULL DEFAULT "" COMMENT '取消备注',
  `venue_id` int NULL DEFAULT NULL COMMENT '基地id',
  `venue_name` varchar(300) NULL DEFAULT "" COMMENT '基地名称',
  `mechant_id` int NULL DEFAULT NULL COMMENT '商户id',
  `mechant_name` varchar(300) NULL DEFAULT "" COMMENT '商户名称',
  `operator_id` int NULL DEFAULT NULL COMMENT '操作id',
  `operator_name` varchar(120) NULL DEFAULT "" COMMENT '操作人名称',
  `is_hidden` tinyint NULL DEFAULT "0" COMMENT '是否查询隐藏',
  `evaluated` tinyint NOT NULL DEFAULT "0" COMMENT '是否已评价',
  `active_status` int NULL DEFAULT NULL COMMENT '是否已激活',
  `active_time` datetime NULL DEFAULT NULL COMMENT '激活时间',
  `sex` int NULL DEFAULT NULL COMMENT '1男2女',
  `sickness` tinyint NOT NULL DEFAULT "0" COMMENT '是否有疾病',
  ...
  `data_type` int NULL DEFAULT "2" COMMENT '1:老数据，2：新数据',
  ...
  `is_jwh_vip` tinyint NOT NULL DEFAULT "0" COMMENT '是否是佳文荟会员订单',

  INDEX `SINGLE_NUM_INDEX` (`order_num`) USING BITMAP,
  INDEX `ik_merchant_id` (`mechant_id`) USING BITMAP,
  INDEX `v` (`venue_id`) USING BITMAP,
  INDEX `s` (`student_id`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT 'order_status: PAYING("100","未付款"), PAID_FIELD("101","已付款"), PAY_CLOSE("102","支付超时"), CANCEL("103","取消订单"), FINISHED("200","已完成"), REFUNDED("300","退款完成"), REFUNDING("301","退款中")'
DISTRIBUTED BY HASH (`id`) BUCKETS 10
PROPERTIES ("replication_num" = "1");
...
CREATE TABLE `ods_wenti_training_m_trade_order_course` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `order_num` varchar(50) NOT NULL COMMENT '订单号',
  `student_id` int NULL DEFAULT NULL COMMENT '学员id',
  ...
  `is_one_card` tinyint NOT NULL DEFAULT "0" COMMENT '是否是一卡通',
  `active_type` int NULL DEFAULT NULL COMMENT '激活类型 1：单课程 2：多课程',
  `active_way` int NULL DEFAULT NULL COMMENT '激活方式 1：择期激活 2：首次使用激活',
  `valid_days` int NULL DEFAULT NULL COMMENT '有效天数',
  `start_date` date NULL DEFAULT NULL COMMENT '开始日期',
  `end_date` date NULL DEFAULT NULL COMMENT '截止日期',
  `course_status` int NOT NULL DEFAULT "1" COMMENT '课程状态：0已完成 1进行中',
  `transfer_from_id` int NULL DEFAULT "0" COMMENT '转课之前的订单详情记录id（m_trade_order_course表的id）',
  `period` int NULL DEFAULT "1" COMMENT '用户相同课程期数',
  ...
  `first_course` tinyint NULL DEFAULT "0" COMMENT '优先卡',

  INDEX `nn` (`order_num`) USING BITMAP,
  INDEX `idx_student` (`student_id`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '订单课程信息表'
...
CREATE TABLE `ods_wenti_training_m_trade_order_detail` (
  ...
  `item_id` int NULL DEFAULT NULL COMMENT '项目id',
  ...
  `market_id` int NULL DEFAULT NULL COMMENT '商超id',
...
CREATE TABLE `ods_wenti_training_m_trade_order_refund` (
  ...
  `is_success` TINYINT NULL DEFAULT "0" COMMENT '退款是否成功',
  `audit_advise` varchar(500) NULL DEFAULT "" COMMENT '审核意见',
  `audit_operator` varchar(120) NULL DEFAULT "" COMMENT '审核人',
  `audit_time` datetime NULL DEFAULT NULL COMMENT '审核时间',
  `operation_type` INT NULL DEFAULT "1" COMMENT '1:退钱，2：不退钱',
  `status` INT NULL DEFAULT "1" COMMENT '1:正常，2：删除',
...
CREATE TABLE `ods_wenti_training_m_transfer_course_record` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `course_id` INT NULL DEFAULT NULL COMMENT '转课后的新课程的课程id，t_course',
  `order_num` varchar(255) NULL DEFAULT NULL COMMENT '转课生成的订单号',
  `old_order_course_id` INT NULL DEFAULT NULL COMMENT '原课程的订单明细id,m_trade_order_course',
  `order_course_id` INT NULL DEFAULT NULL COMMENT '新课程的订单明细id,m_trade_order_course',
  ...
  `spec_id` INT NULL DEFAULT NULL COMMENT '转课后新课程的规格id（t_course_spec表）',
  `class_hour` decimal(10, 2) NULL DEFAULT NULL COMMENT '转课后新课程的课时（t_course_spec表）',
  `student_id` INT NULL DEFAULT NULL COMMENT '学生id',
  `is_success` TINYINT NULL DEFAULT "0" COMMENT '是否转课成功',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_training_t_class` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `merchant_id` INT NOT NULL COMMENT '商户id',
  `venue_id` INT NOT NULL COMMENT '场馆id(训练基地id)',
  ...
  `sport_id` INT NULL DEFAULT NULL COMMENT '运用类型id',
  `class_hour` decimal(11, 2) NULL DEFAULT NULL COMMENT '课时',
  `present` TINYINT NULL DEFAULT NULL COMMENT '缺课是否扣除课时',
  `reserve_enable` TINYINT NOT NULL DEFAULT "0" COMMENT '是否启用预约限制人数',
  `reserve_hour` INT NULL DEFAULT NULL COMMENT '开课前x小时',
  `reserve_people` INT NULL DEFAULT NULL COMMENT '预约限制人数',
  `reserve_cancel_hour` INT NULL DEFAULT NULL COMMENT '开课前x小时不能取消约课',
  `remind_enable` TINYINT NOT NULL DEFAULT "0" COMMENT '是否启用上课提醒',
  `remind_hour` INT NULL DEFAULT NULL COMMENT '开课前x小时提醒',
  `remark` varchar(255) NULL DEFAULT NULL COMMENT '备注',
  ...
  `sale_status` INT NOT NULL DEFAULT "0" COMMENT '上/下架状态 0-下架 1-上架'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '班级表'
...
CREATE TABLE `ods_wenti_training_t_class_teacher` (
  ...
  `taught_class_hour` INT NULL DEFAULT NULL COMMENT '已售课时',
  `commission_type` INT NULL DEFAULT NULL COMMENT '提成类型 1:百分比 2：固定',
  ...
  `group_commission_type` INT NULL DEFAULT NULL COMMENT '团体课提成类型 1:百分比 2：固定'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '教师-班级关联表'
...
CREATE TABLE `ods_wenti_training_t_student` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `merchant_id` INT NULL DEFAULT NULL COMMENT '商户id',
  `venue_id` INT NULL DEFAULT NULL COMMENT '场馆id(训练基地id)',
  ...
  `card_id` INT NULL DEFAULT NULL COMMENT '实体卡id',
  `sex` INT NULL DEFAULT NULL COMMENT '1男2女',
  ...
  `class_hour` INT NULL DEFAULT NULL COMMENT '课时',
...
CREATE TABLE `ods_wenti_training_t_student_check` (
  ...
  `syllabus_student_id` INT NULL DEFAULT NULL COMMENT '上课记录id',
...
CREATE TABLE `ods_wenti_training_t_student_course` (
  ...
  `course_id` INT NOT NULL COMMENT '课程id',
  `order_course_id` INT NULL DEFAULT NULL COMMENT '订单明细id,m_trade_order_course',
  `class_id` INT NULL DEFAULT NULL COMMENT '班级id',
  `ori_order_course_id` INT NULL DEFAULT NULL COMMENT '原始订单明细id'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '学生参加课程表'
...
CREATE TABLE `ods_wenti_training_t_student_jnl` (
  ...
  `student_id` INT NOT NULL COMMENT '学生id',
  `is_default` INT NOT NULL COMMENT '是否默认(1-默认,2-不默认)(一起吗默认显示学生信息)',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `ods_wenti_training_t_student_transfer` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `student_id` INT NULL DEFAULT NULL COMMENT '学生id',
  `ori_course_id` INT NULL DEFAULT NULL COMMENT '原课程id',
  `ori_course_name` varchar(50) NULL DEFAULT NULL COMMENT '原课程名',
  `new_course_id` INT NULL DEFAULT NULL COMMENT '新课程id',
...
CREATE TABLE `ods_wenti_training_t_syllabus_student` (
  ...
  `merchant_id` INT NOT NULL COMMENT '商户id',
  `venue_id` INT NOT NULL COMMENT '场馆id(训练基地id)',
  `syllabus_id` INT NOT NULL COMMENT '课程安排id',
  `student_id` INT NOT NULL COMMENT '学生id',
  `order_course_id` INT NOT NULL COMMENT '订单明细id,m_trade_order_course',
  `deduct_amount` decimal(20, 2) NULL DEFAULT NULL COMMENT '课消金额',
  `status` INT NULL DEFAULT NULL COMMENT '考勤状态 0：待上课 1：已签到 2：已点名 3：请假 4：缺课',
  `class_hour` decimal(11, 2) NULL DEFAULT NULL COMMENT '消耗课时',
  `is_reserve` TINYINT NOT NULL DEFAULT "0" COMMENT '是否预约',
  `is_insert` TINYINT NOT NULL DEFAULT "0" COMMENT '是否插课',
  `is_deduct` TINYINT NOT NULL DEFAULT "1" COMMENT '是否抵扣课时',
  `is_check` TINYINT NOT NULL DEFAULT "0" COMMENT '是否签到',
  `check_type` TINYINT NULL DEFAULT "0" COMMENT '签到类型：0前台，1闸机',
  `check_count` INT NULL DEFAULT "0" COMMENT '闸机签到时，统计次数',
  `is_call` TINYINT NOT NULL DEFAULT "0" COMMENT '是否已点名',
  `is_leave` TINYINT NOT NULL DEFAULT "0" COMMENT '是否已请假',
  `is_this` TINYINT NOT NULL DEFAULT "1" COMMENT '是否本班学员',
  `is_temp` TINYINT NOT NULL DEFAULT "0" COMMENT '是否临时添加',
  `check_time` varchar(20) NULL DEFAULT NULL COMMENT '签到时间',
  ...
  `leave_type` INT NULL DEFAULT NULL COMMENT '请假方式 0：线下 1：线上',

  INDEX `student_id` (`student_id`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '学生上课记录表'
...
CREATE TABLE `ods_wenti_vmdb_gate_link_lock` (
  ...
  `status` INT NULL DEFAULT NULL COMMENT '1-开闸 2-租柜 3-还柜 4-出闸',
  ...
  `registed_palm` TINYINT NOT NULL DEFAULT "0" COMMENT '是否注册了掌纹',
...
CREATE TABLE `ods_wenti_vmdb_h_card` (
  ...
  `venue_id` INT NOT NULL COMMENT '场馆id',
  `merchant_id` INT NOT NULL COMMENT '商户id',
  `channel` INT NULL DEFAULT "1" COMMENT '数据来源渠道，1：pc，2：app，注意：与h_member_record表取值不一致',

  INDEX `idx_merchant_id` (`merchant_id`) USING BITMAP,
  INDEX `idx_card_code` (`card_code`) USING BITMAP,
  INDEX `idx_card_track` (`card_track`) USING BITMAP
)
ENGINE = OLAP
...
CREATE TABLE `ods_wenti_vmdb_h_card_vip` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `member_id` INT NOT NULL COMMENT '会员id',
  `card_id` INT NOT NULL COMMENT '关联实体卡id',
  `venue_id` INT NOT NULL COMMENT '场馆id',
  `merchant_id` INT NOT NULL COMMENT '商户id',
  `is_valid` TINYINT NOT NULL DEFAULT "0" COMMENT '是否消费验证',
  `is_work_cost` TINYINT NOT NULL DEFAULT "0" COMMENT '是否收取工本费',
  `order_num` varchar(30) NULL DEFAULT "" COMMENT '订单号',
  `model_type` INT NULL DEFAULT NULL COMMENT '收费类型（1.办卡工本费 2.补卡工本费）',
  `is_main` TINYINT NOT NULL DEFAULT "0" COMMENT '是否为主卡',
  `enabled` TINYINT NOT NULL DEFAULT "1" COMMENT '是否可用（0停用 1可用）',
  `is_deleted` TINYINT NOT NULL DEFAULT "0" COMMENT '是否删除',
  ...
  INDEX `MEMBER_ID` (`member_id`) USING BITMAP,
  INDEX `CARD_ID` (`card_id`) USING BITMAP,
  INDEX `MERCHANT_ID` (`merchant_id`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '会员卡(实体卡绑定)表'
...
CREATE TABLE `ods_wenti_vmdb_h_id_card_check_record` (
  ...
  `type` INT NULL DEFAULT "1" COMMENT '1 老人2少年',
  `code` varchar(11) NULL DEFAULT NULL COMMENT '成功为200（10000），其它为失败状态码',
  `company_type` INT NULL DEFAULT "1" COMMENT 'company_type 1 天眼 2网易 3数据宝',
  `msg` varchar(255) NOT NULL DEFAULT "" COMMENT 'code对应的说明描述',
  `result` INT NOT NULL DEFAULT "1" COMMENT '1-一致，2-不一致，3：异常情况',
  `order_no` varchar(255) NULL DEFAULT NULL COMMENT '订单号',
  `sex` varchar(255) NULL DEFAULT NULL COMMENT '性别',
  `check_desc` varchar(255) NULL DEFAULT NULL COMMENT '验证结果描述信息',
  `birthday` varchar(255) NULL DEFAULT NULL COMMENT '生日',
  ...
  `task_id` varchar(255) NULL DEFAULT NULL COMMENT '本次请求数据标识，可以根据该标识在控制台进行数据查询',
  `reason_type` INT NULL DEFAULT "1" COMMENT '原因详情，1：认证通过 2：输入姓名和身份证号不一致 3：查无此身份证 7：结果获取失败，请重试',
  `status` INT NOT NULL DEFAULT "0" COMMENT '认证结果，1：认证通过，2：认证不通过',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `source` INT NULL DEFAULT "1" COMMENT '来源 1:馆佳pc 2:一起吗'
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT 'id_card校验表'
...
CREATE TABLE `ods_wenti_vmdb_h_member` (
  ...
  `card_id` INT NULL DEFAULT NULL COMMENT '关联实体卡id',
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_user_id` INT NOT NULL COMMENT '创建人员id',
  `up_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  `up_user_id` INT NOT NULL COMMENT '修改人员id',
  `venue_id` INT NOT NULL COMMENT '场馆id',
  `merchant_id` INT NOT NULL COMMENT '商户id',
  `is_deleted` TINYINT NOT NULL DEFAULT "0" COMMENT '是否删除',
  `is_valid` TINYINT NULL DEFAULT "0" COMMENT '是否消费验证',
  `is_work_cost` TINYINT NULL DEFAULT "0" COMMENT '是否收取工本费',
  `order_num` varchar(30) NULL DEFAULT NULL COMMENT '订单号',
  `model_type` INT NULL DEFAULT NULL COMMENT '收费类型（1.办卡工本费 2.补卡工本费）',
  `channel` INT NULL DEFAULT "1" COMMENT '数据来源渠道，1：pc，2：app',
  `is_success` TINYINT NULL DEFAULT "0" COMMENT '线上开卡是否注册成功（只对线上开卡有用）',
  `urgent_name` varchar(255) NULL DEFAULT "" COMMENT '紧急联系人',
  `urgent_phone` varchar(255) NULL DEFAULT "" COMMENT '紧急联系人电话',
  `is_face_enable` TINYINT NOT NULL DEFAULT "1" COMMENT '人脸是否可用 0-不可用 1-可用',
  ...
  `id_card_check` INT NULL DEFAULT "1" COMMENT ' id_card校验 1：未校验，2：已校验，3：过期，4：禁用',
  `id_card_expire_date` datetime NULL DEFAULT NULL COMMENT 'id_card有效期',
  `report_expire_date` datetime NULL DEFAULT NULL COMMENT '体检有效期',
  `report_check` INT NULL DEFAULT "1" COMMENT ' 体检校验 1：未上传， 2：审核中、3：审核通过、4：审核未通过、5：已过期、6：已禁用',
  `signature` varchar(255) NULL DEFAULT NULL COMMENT '签名',

  INDEX `idx_merchant_id` (`merchant_id`) USING BITMAP,
  INDEX `card_id` (`card_id`) USING BITMAP,
  INDEX `venue_id` (`venue_id`) USING BITMAP,
  INDEX `create_user_id` (`create_user_id`) USING BITMAP,
  INDEX `up_user_id` (`up_user_id`) USING BITMAP,
  INDEX `phone` (`phone`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_vmdb_h_member_card` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `member_id` INT NOT NULL COMMENT '会员id',
  `card_vip_id` INT NULL DEFAULT NULL COMMENT '会员实体卡id',
  ...
  `status` INT NOT NULL COMMENT '状态（1.正常 2.停用 3.过期）',
  `card_sales_id` INT NOT NULL COMMENT '售卡id',
  `update_date` datetime NOT NULL COMMENT '修改时间',
  `create_date` datetime NOT NULL COMMENT '创建时间',
  `update_user_id` INT NOT NULL COMMENT '修改人',
  `create_user_id` INT NOT NULL COMMENT '创建人',
  `enable_date` datetime NULL DEFAULT NULL COMMENT '启用日期',
  `sluice_priority` TINYINT NOT NULL DEFAULT "0" COMMENT '入闸优先级（是否优先）',
  `venue_id` INT NOT NULL COMMENT '场馆id',
  `merchant_id` INT NOT NULL COMMENT '商户id',
  `is_active` INT NOT NULL DEFAULT "0" COMMENT '是否激活（0未激活 1已激活）一起吗端使用',
  `last_end_effect_date` datetime NULL DEFAULT NULL COMMENT '记录修改前的有效期',
  `channel` INT NULL DEFAULT "1" COMMENT '数据来源渠道，1：pc，2：app',
  `owe_flag` TINYINT NOT NULL DEFAULT "0" COMMENT '是否欠费',
  `prepaid_balance` decimal(10, 2) NULL DEFAULT NULL COMMENT '预收入余额',

  INDEX `idx_member_id` (`member_id`) USING BITMAP,
  INDEX `idx_card_sales_id` (`card_sales_id`) USING BITMAP,
  INDEX `card_index` (`card_vip_id`) USING BITMAP,
  INDEX `venue_id` (`venue_id`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_vmdb_h_member_deducted` (
  ...
  `member_card_id` int NOT NULL COMMENT '专项卡id',
...
CREATE TABLE `ods_wenti_vmdb_h_member_record` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `member_card_id` int NOT NULL COMMENT '专项卡记录id',
  `type` int NOT NULL COMMENT '类型（0.记账,1.退款 2.消费 3.充值）',
  `order_num` varchar(30) NULL DEFAULT NULL COMMENT '订单号',
  ...
  `balance` decimal(10, 2) NULL DEFAULT NULL COMMENT '余额/次',
  `present_balance` decimal(10, 2) NULL DEFAULT "0.00" COMMENT '赠送余额',
  `channel` int NULL DEFAULT NULL COMMENT '渠道（1.网络 2.线下），注意：该字段与其他表取值不一致',
  `remarks` varchar(255) NULL DEFAULT NULL COMMENT '备注',
  `op_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '操作时间',
  `op_user_id` int NULL DEFAULT NULL COMMENT '操作人员id',
  `sell_price` decimal(13, 2) NULL DEFAULT NULL COMMENT '售价',
  `pay_amount` decimal(13, 2) NULL DEFAULT "0.00" COMMENT '实付金额',
  `consume_type` int NULL DEFAULT "1" COMMENT '消费类型(0.记账,1.抵扣 2.签到 3.入闸)',
  ...
  INDEX `idx_member_card_id` (`member_card_id`) USING BITMAP,
  INDEX `idx_order_num` (`order_num`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_vmdb_h_member_report_approval` (
  ...
  `status` int NOT NULL DEFAULT "0" COMMENT '状态 1：未上传， 2：审核中、3：审核通过、4：审核未通过、5：已过期、6：已禁用 ',
  `valid_date` datetime NULL DEFAULT NULL COMMENT '有效期',
  `approval_user_id` int NULL DEFAULT NULL COMMENT '审核人id',
  ...
  `uuid` varchar(200) NULL DEFAULT NULL COMMENT 'uuid',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `create_user_id` int NULL DEFAULT NULL COMMENT '创建人员id',
  `create_name` varchar(20) NULL DEFAULT NULL COMMENT '创建人',
  `update_time` datetime NOT NULL COMMENT '修改时间',
  `update_user_id` int NULL DEFAULT NULL COMMENT '修改人员id',
  ...
  INDEX `idx_venue_id` (`venue_id`) USING BITMAP,
  INDEX `idx_member_id` (`member_id`) USING BITMAP,
  INDEX `idx_member_report_approval_phone` (`phone`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '用户体检报告审核'
...
CREATE TABLE `ods_wenti_vmdb_m_enter_gate` (
  ...
  `merchant_id` int NOT NULL COMMENT '商户id',
  `venue_id` int NOT NULL COMMENT '场馆id',
  `type` int NOT NULL COMMENT '1.单次卡 2.次卡 3.场次卡 4.二维码 5.时段卡 6.管理卡',
  `qr_code_type` int NULL DEFAULT NULL COMMENT '二维码类型 1.散票 2.团体票 3.通票',
  `card_name` varchar(50) NULL DEFAULT NULL COMMENT '卡名',
  `item_id` int NULL DEFAULT NULL COMMENT '不同类型对应不同id',
  ...
  `status` int NOT NULL COMMENT '状态 1.正常 2.已撤回',
  `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `ods_wenti_vmdb_m_group_ticket_no` (
  ...
  `merchant_id` int NOT NULL COMMENT '商户id',
  `venue_id` int NOT NULL COMMENT '场馆id',
  `sale_id` int NULL DEFAULT NULL COMMENT '销售记录id',
  `pregeneration_id` int NULL DEFAULT NULL COMMENT '预生成记录id',
  `ticket_no` varchar(50) NOT NULL COMMENT '票号',
  `random_code` varchar(10) NULL DEFAULT NULL COMMENT '随机码',
  `remain_num` int NOT NULL COMMENT '剩余核销次数',
  `verify_num` int NOT NULL DEFAULT "0" COMMENT '前台核销次数',
  `bingding_status` int NOT NULL DEFAULT "0" COMMENT 'C端绑定状态 1：已绑定',
  `bingding_mobile` varchar(20) NULL DEFAULT NULL COMMENT 'C端绑定绑定手机号',
  `enter_gate_num` int NOT NULL DEFAULT "0" COMMENT '入闸核销次数',
  `status` int NOT NULL COMMENT '状态 0：未激活 1：已激活 2：已使用 3：部分使用 4.已过期',
  `verify_time` datetime NULL DEFAULT NULL COMMENT '首次核销时间',
  `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_updated` datetime NOT NULL COMMENT '更新时间',
  `viewd` tinyint NULL DEFAULT "0" COMMENT '是否已读',

  INDEX `ik_ticket_no` (`ticket_no`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '团体票号表'
...
CREATE TABLE `ods_wenti_vmdb_m_group_ticket_sale` (
  ...
  `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `gmt_updated` datetime NOT NULL COMMENT '更新时间',
  `give_total` int NOT NULL DEFAULT "0" COMMENT '赠送数量',
  `start_date` date NULL DEFAULT NULL COMMENT '开始日期',
...
CREATE TABLE `ods_wenti_vmdb_m_group_ticket_verify` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `ticket_no_id` int NOT NULL COMMENT '团体票票号id',
  `gmt_create` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',

  INDEX `ik_ticket_no` (`ticket_no_id`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '团体票号核销记录表'
...
CREATE TABLE `ods_wenti_vmdb_m_trade_order` (
  ...
  `order_item_type` varchar(20) NULL DEFAULT "" COMMENT '订单项目类型',
  `is_account_business` tinyint NULL DEFAULT "0" COMMENT '是否记账订单',
  `is_new_card` tinyint NOT NULL DEFAULT "0" COMMENT '是否为新卡(仅充值有效)',
  `order_ticket_type` int NULL DEFAULT NULL COMMENT '售票订单票务类型 1：散票 2：团体票',
  `member_id` int NULL DEFAULT NULL COMMENT '会员id',
  `card_vip_id` int NULL DEFAULT NULL COMMENT '会员vipId',
  `customer_phone` varchar(50) NULL DEFAULT "" COMMENT '客户手机号',
  `customer_name` varchar(200) NULL DEFAULT "" COMMENT '客户名称',
  ...
  `operator_name` varchar(120) NULL DEFAULT "" COMMENT '操作人名称',
  `is_hidden` tinyint NULL DEFAULT "0" COMMENT '是否查询隐藏',
  `is_discount` tinyint NULL DEFAULT "0" COMMENT '是否需要输入折扣',
  `evaluated` tinyint NOT NULL DEFAULT "0" COMMENT '是否已评价',
  `is_switch` tinyint NOT NULL DEFAULT "0" COMMENT '是否已换场',
  `is_book_field` tinyint NOT NULL DEFAULT "0" COMMENT '是否是场地预定订单',
  `is_invoice` tinyint NULL DEFAULT "0" COMMENT '是否已开发票',
  ...
  `is_update_status` tinyint NULL DEFAULT NULL COMMENT '是否已更新状态（未付款、支付超时、系统自动退款、取消订单操作）',
  ...
  `third_paid` tinyint NOT NULL DEFAULT "0" COMMENT '是否通过第三方支付',

  INDEX `idx_single_num` (`order_num`) USING BITMAP,
  INDEX `idx_merchant_id` (`mechant_id`) USING BITMAP,
  INDEX `idx_link_order_num` (`link_order_num`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '交易订单主表'
...
CREATE TABLE `ods_wenti_vmdb_m_trade_order_coupon` (
  ...
  `venue_id` int NOT NULL COMMENT '场馆id',
  `coupon_id` int NOT NULL COMMENT '商户优惠券id',

  INDEX `idx_coupon_id` (`coupon_id`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '交易订单-优惠券使用表'
...
CREATE TABLE `ods_wenti_vmdb_m_trade_order_detail` (
  ...
  `merchant_discount` decimal(12, 2) NULL COMMENT '商家优惠金额',
  `landlord_discount` decimal(12, 2) NULL COMMENT '租主优惠金额',
  `due_amount` decimal(13, 2) NULL COMMENT '应付合计',
  `amount` decimal(13, 2) NULL COMMENT '合计',
  `stat_flag` tinyint NULL COMMENT '统计标志',
  `market_id` int NULL COMMENT '商品收银时-商超id',
  `goods_amount` decimal(10, 2) NULL COMMENT '商品收银时-商品成本金额',
  `is_new_card` tinyint NULL COMMENT '是否为新卡(仅充值有效)',
  `goods_receiver_code` varchar(255) NULL COMMENT '批次号',
  `goods_sale_tax` decimal(12, 2) NULL COMMENT '税率',
...
CREATE TABLE `ods_wenti_vmdb_m_trade_order_field` (
  ...
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `order_num` varchar(50) NULL DEFAULT NULL COMMENT '订单号',
  `order_detail_id` int NULL DEFAULT "0" COMMENT '订单详情id',
  `field_detail_id` int NOT NULL COMMENT '场地详情id',
  ...
  `origin_type` tinyint NOT NULL DEFAULT "0" COMMENT '来源类型(是否C端订单)',
  `start_time` varchar(6) NOT NULL COMMENT '开始时间',
  `end_time` varchar(6) NOT NULL COMMENT '结束时间',
  `fixed_id` int NULL DEFAULT NULL COMMENT '固定场记录id',
  `lock_status` tinyint NULL DEFAULT "0" COMMENT '锁场是否已收款',
  `type` int NOT NULL DEFAULT "1" COMMENT '预定类型（0.会员预定 1.散客 2.票券）',
  `card_vip_id` int NULL DEFAULT NULL COMMENT '会员卡id',
  `card_code` varchar(200) NULL DEFAULT "" COMMENT '会员卡号',

  INDEX `idx_field_detail_id` (`field_detail_id`) USING BITMAP,
  INDEX `idx_field_date` (`field_date`) USING BITMAP,
  INDEX `SINGLE_NUM_INDEX` (`order_num`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
...
CREATE TABLE `ods_wenti_vmdb_m_trade_order_field_gate` (
  ...
  `venue_id` int NULL DEFAULT NULL COMMENT '场馆id',
  `order_num` varchar(50) NOT NULL COMMENT '订单号',
  `remain_num` int NULL DEFAULT NULL COMMENT '剩余核销次数',
  `verify_num` int NOT NULL DEFAULT "0" COMMENT '前台核销次数',
  `enter_gate_num` int NOT NULL DEFAULT "0" COMMENT '入闸核销次数',
  `first_verify_time` datetime NULL DEFAULT NULL COMMENT '首次核销时间',
  `status` int NULL DEFAULT NULL COMMENT '0:未使用 1:已使用 2:已过期 3:已退款',
  `field_id` int NULL DEFAULT NULL COMMENT '场地id',
  ...
  `door_remain_num` int NULL DEFAULT NULL COMMENT '门禁可用次数',
  `door_enter_num` int NULL DEFAULT NULL COMMENT '门禁进入次数',
...
CREATE TABLE `ods_wenti_vmdb_m_trade_order_pay` (
  ...
  `pay_entity_id` int NULL DEFAULT "0" COMMENT '支付实体id',
  ...
  `is_main_pay` tinyint NULL DEFAULT "0" COMMENT '是否为主要支付',
  `is_refund` tinyint NULL DEFAULT "0" COMMENT '是否退款',

  INDEX `ORDER_NUM` (`order_num`) USING BITMAP,
  INDEX `REFUND_NUM` (`refund_num`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '交易订单支付表'
...
CREATE TABLE `ods_wenti_vmdb_m_trade_order_refund` (
  ...
  `refund_remark` varchar(300) NULL DEFAULT "" COMMENT '退款备注',
  `refund_type` varchar(20) NULL DEFAULT "" COMMENT '退款方式',
  `refund_param` VARCHAR(65533) NULL COMMENT '退款参数',
  `refund_response` VARCHAR(65533) NULL COMMENT '第三方返回响应',
  `fail_reason` varchar(300) NULL DEFAULT "" COMMENT '第三方退款失败原因',
  `refund_status` varchar(20) NULL DEFAULT "" COMMENT '退款状态',
  `is_success` tinyint NULL DEFAULT "0" COMMENT '退款是否成功',
  `audit_advise` varchar(500) NULL DEFAULT "" COMMENT '审核意见',
...
CREATE TABLE `ods_wenti_vmdb_m_trade_order_refund_offline` (
  ...
  `venue_id` int NULL DEFAULT NULL COMMENT '场馆id',
  `venue_name` varchar(300) NULL DEFAULT "" COMMENT '场馆名称',
  `refund_status` int NULL DEFAULT "1" COMMENT '退款状态(1:成功，2：删除)',
  `audit_advise` varchar(500) NULL DEFAULT "" COMMENT '审核意见',
  `audit_operator` varchar(120) NULL DEFAULT "" COMMENT '审核人',
  `audit_id` int NULL DEFAULT NULL COMMENT '审核人',
  `audit_time` datetime NULL DEFAULT NULL COMMENT '审核时间',
...
CREATE TABLE `ods_wenti_vmdb_m_trade_order_ticket` (
  ...
  `venue_id` int NOT NULL COMMENT '场馆id',
  `order_num` varchar(50) NOT NULL COMMENT '订单号',
  `ticket_id` int NOT NULL COMMENT '散票id',
  `ticket_name` varchar(50) NOT NULL COMMENT '散票名',
  `ticket_attr` int NULL DEFAULT NULL COMMENT '属性，1：成人 2：儿童 3：学生 4：老人 5：套票',
...
CREATE TABLE `ods_wenti_vmdb_m_trade_order_ticket_no` (
  ...
  `merchant_id` int NULL DEFAULT NULL COMMENT '商户id',
  `venue_id` int NULL DEFAULT NULL COMMENT '场馆id',
  `order_ticket_id` int NULL DEFAULT NULL COMMENT '订单售票id',
  ...
  INDEX `ik_ticket_no` (`ticket_no`) USING BITMAP,
  INDEX `ik_order_ticket_id` (`order_ticket_id`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '散票票号表'
...
CREATE TABLE `ods_wenti_vmdb_m_trade_order_ticket_verify` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `order_ticket_no_id` int NOT NULL COMMENT '散票票号id',
  `ticket_attr` int NULL DEFAULT NULL COMMENT '属性，1：成人 2：儿童 3：学生 4：老人',
  `verify_time` datetime NULL DEFAULT NULL COMMENT '核销时间',
  `is_verify` tinyint NOT NULL DEFAULT "0" COMMENT '是否已核销',

  INDEX `ik_ticket_no` (`order_ticket_no_id`) USING BITMAP
)
ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '散票核销表'
...
CREATE TABLE `ods_wenti_vmdb_m_venue_customer` (
  ...
  `type` int NOT NULL COMMENT '用户类型 1.非会员 2。场馆会员',
  `consume_num` int NOT NULL DEFAULT "0" COMMENT '消费次数',
  `channel` int NOT NULL COMMENT '渠道 1.B端 2.C端',
  `venue_id` int NOT NULL COMMENT '场馆id',
...
CREATE TABLE `ods_wenti_vmdb_p_park_record` (
  ...
  `is_member` tinyint NOT NULL DEFAULT "1" COMMENT '是否是会员',
  `user_name` varchar(255) NULL DEFAULT NULL COMMENT '用户名称',
  `user_phone` varchar(20) NULL DEFAULT NULL COMMENT '用户手机号',
  `car_no` varchar(50) NULL DEFAULT NULL COMMENT '车牌号',
  ...
  `park_time` int NULL DEFAULT NULL COMMENT '停车时长',
  ...
  `valid_time_len` int NULL DEFAULT NULL COMMENT '有效支付时长秒数',
  `free_minute` int NULL DEFAULT NULL COMMENT '免费时长分钟数',
  `pay_status` tinyint NOT NULL COMMENT '0-未支付 1-已经支付',
  `ticket_id` int NULL DEFAULT NULL COMMENT '停车券id',
...
CREATE TABLE `ods_wenti_vmdb_p_park_ticket` (
  ...
  `config_id` int NOT NULL COMMENT '发券配置id',
  `name` varchar(255) NOT NULL COMMENT '停车券名',
  `merchant_id` int NOT NULL COMMENT '商户id',
  `merchant_name` varchar(255) NOT NULL COMMENT '商户名称',
  `channel` tinyint NOT NULL DEFAULT "0" COMMENT '渠道 0：线下，1：线上',
  `scene` tinyint NOT NULL DEFAULT "0" COMMENT '发放场景，0：线下， 1：订场，2：售票，3：刷卡',
  `deducted_hour` decimal(10, 1) NOT NULL DEFAULT "0.0" COMMENT '抵扣时长',
  `is_member` tinyint NOT NULL DEFAULT "0" COMMENT '是否会员， 0：否， 1：是',
  ...
  `soure_member_card_id` int NULL DEFAULT NULL COMMENT '停车券来源卡号',
  `source_give_detail_id` int NULL DEFAULT NULL COMMENT '赠送详情id',
...
CREATE TABLE `ods_wenti_vmdb_p_park_ticket_give_record` (
  ...
  `config_id` int NOT NULL COMMENT '停车券配置id',
  `old_ticket_id` int NULL DEFAULT NULL COMMENT '旧停车券id',
  `new_ticket_id` int NULL DEFAULT NULL COMMENT '新停车券id',
...
CREATE TABLE `ods_wenti_vmdb_theatre_sale_channel` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `user_id` int NULL DEFAULT NULL COMMENT '分享者id',
...
CREATE TABLE `ods_wenti_vmdb_theatre_sale_channel_detail` (
  ...
  `commission_ratio` int NULL DEFAULT NULL COMMENT '佣金比例',
...
CREATE TABLE `ods_wenti_vmdb_theatre_ticket_discount` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `sell_id` int NOT NULL COMMENT '场次id',
  `area_code` varchar(255) NULL DEFAULT NULL COMMENT '座位区域',
  `min_number` int NULL DEFAULT NULL COMMENT '最少张数',
...
CREATE TABLE `ods_wenti_vmdb_theatre_ticket_item` (
  `id` INT NOT NULL COMMENT 'id（业务主键）',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `venue_id` int NULL DEFAULT NULL COMMENT '场馆',
  ...
  `info` VARCHAR(1048576) NULL COMMENT '详情',
  ...
  `choose_seat_flag` tinyint NOT NULL DEFAULT "1" COMMENT '是否选座',
  `type` int NOT NULL DEFAULT "1" COMMENT '项目类型 1-演艺 2-赛事',
...
CREATE TABLE `ods_wenti_vmdb_theatre_ticket_lock_log`  (
  ...
  `ticket_num` int NULL DEFAULT NULL COMMENT '票数',
  `type` int NULL DEFAULT NULL COMMENT '类型 0-解锁 -1-锁定',
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  INDEX `idx_sell_id`(`sell_id`) USING BITMAP
) ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '剧场票务-场次表'
DISTRIBUTED BY HASH (`id`) BUCKETS 10
...
CREATE TABLE `ods_wenti_vmdb_theatre_ticket_price`  (
  ...
  `stock` int NULL DEFAULT NULL COMMENT '无座时表示数量',
  `remaining_stock` int NULL DEFAULT NULL COMMENT '剩余数量',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `is_deleted` tinyint NOT NULL DEFAULT "0" COMMENT '是否删除',
  INDEX `idx_sell_id`(`sell_id`) USING BITMAP
) ENGINE = OLAP
...
CREATE TABLE `ods_wenti_vmdb_theatre_ticket_seat`  (
  ...
  `num_x` int NULL DEFAULT NULL COMMENT 'Y轴',
  `col_no` int NULL DEFAULT NULL COMMENT '列号',
  `num_y` int NULL DEFAULT NULL COMMENT 'X轴',
  ...
  `is_side` tinyint NOT NULL DEFAULT "0" COMMENT '是否间隔',
  `plan_id` int NULL DEFAULT NULL COMMENT '区域方案',
  INDEX `idx_venue_id`(`venue_id`) USING BITMAP
) ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '剧场票务-座位图'
...
CREATE TABLE `ods_wenti_vmdb_theatre_ticket_sell`  (
  `id` int NOT NULL COMMENT '主键id',
  `extract_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据采集时间',
  `item_id` int NOT NULL COMMENT '演出项目id',
  `status` int NULL DEFAULT NULL COMMENT '状态 1-上架 0-下架',
  `start_time` datetime NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime NULL DEFAULT NULL COMMENT '结束时间',
  `is_deleted` tinyint NOT NULL DEFAULT "0" COMMENT '是否删除',
  `settled` tinyint NOT NULL DEFAULT "0" COMMENT '是否结算',
  `plan_id` int NULL DEFAULT NULL COMMENT '区域方案',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  ...
  `third_project_id` varchar(255) NULL DEFAULT NULL COMMENT '第三方项目id',
  `third_project_type` varchar(20) NULL DEFAULT NULL COMMENT '第三方项目类型',
  `rule_type` int NULL DEFAULT "0" COMMENT '实名规则 0非实名 1一票一证',
...
CREATE TABLE `ods_wenti_vmdb_theatre_ticket_sell_detail`  (
  ...
  `seat_num_x` int NULL DEFAULT NULL COMMENT '座位坐标X',
  `seat_num_y` int NULL DEFAULT NULL COMMENT '座位坐标Y',
  `seat_row_no` int NULL DEFAULT NULL COMMENT '座位排号',
  `seat_col_no` int NULL DEFAULT NULL COMMENT '座位列号',
  `is_side` tinyint NULL DEFAULT NULL COMMENT '是否边座',
  `area_name` varchar(255) NULL DEFAULT NULL COMMENT '座位区域',
  `area_code` varchar(255) NULL DEFAULT NULL COMMENT '座位区域',
  `status` int NULL DEFAULT NULL COMMENT '状态 -1-锁定 0-正常 1-待付款 2-已付款 3-已核销 4-已过期',
  `order_num` varchar(255) NULL DEFAULT NULL COMMENT '订单号',
  `customer_phone` varchar(255) NULL DEFAULT NULL COMMENT '客户手机号',
  `customer_name` varchar(255) NULL DEFAULT NULL COMMENT '客户姓名',
  `cert_type` int NULL DEFAULT NULL COMMENT '客户证件类型 1-身份证',
  ...
  `verify_time` datetime NULL DEFAULT NULL COMMENT '核销时间',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `price_id` int NULL DEFAULT NULL COMMENT '票价id',
  `price` decimal(10, 2) NULL DEFAULT NULL COMMENT '价格',
  ...
  `third_type` int NULL DEFAULT NULL COMMENT '第三方类型 1-大麦 2-猫眼',
  ...
  `choose_seat_flag` tinyint NOT NULL DEFAULT "1" COMMENT '是否选座',
  INDEX `idx_sell_id`(`sell_id`) USING BITMAP,
  INDEX `idx_order`(`order_num`) USING BITMAP
) ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '剧场票务-场次表'
DISTRIBUTED BY HASH (`id`) BUCKETS 10
...
CREATE TABLE `ods_wenti_vmdb_theatre_ticket_third_order`  (
  ...
  `order_num` varchar(255) NULL DEFAULT NULL COMMENT '订单号',
  `third_order_num` varchar(255) NULL DEFAULT NULL COMMENT '第三方订单号',
  `third_type` int NULL DEFAULT NULL COMMENT '第三方类型',
  `order_time` datetime NULL DEFAULT NULL COMMENT '下单时间',
  `is_pay` tinyint NULL DEFAULT "0" COMMENT '是否支付',
  `is_cancel` tinyint NULL DEFAULT NULL COMMENT '是否退票',
  `total_amount` bigint NULL DEFAULT NULL COMMENT '订单总金额',
  `real_amount` bigint NULL DEFAULT NULL COMMENT '实付金额',
  INDEX `idx_order_num`(`order_num`) USING BITMAP
) ENGINE = OLAP
DUPLICATE KEY (`id`)
COMMENT '剧场票务-第三方订单表'
